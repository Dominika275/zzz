...
function z1()
{
	document.getElementById("id1").innerHTML="Zeszyt";
}
...
function z3()
{
	document.getElementById("id3").innerHTML="Cyrk";
}
...
function z5()
{
	document.getElementById("id5").innerHTML="Chrząszcz";
}
...
function z7()
{
	document.getElementById("id7").innerHTML="Deszcz";
}
...
function z9()
{
	document.getElementById("id9").innerHTML="Schody";
}
